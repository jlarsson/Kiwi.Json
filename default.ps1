...
task pack -depends build {
	$projects | foreach { `
		& $nuget_tool pack $_.nuspec -p "id=$($_.id);version=$pack_version;title=$($_.title);author=$pack_.author;description=$($_.description);copyright=$pack_.copyright;libdir=..\pack\lib"
	}
}
